...
public class TestECB {
    ...
    public static void main(String[] args) throws NoSuchPaddingException, IllegalBlockSizeException, IOException, NoSuchAlgorithmException, BadPaddingException, NoSuchProviderException, InvalidKeyException {
        encrypt("src/main/java/ro/ase/ism/sap/DAY03/msg.txt", "src/main/java/ro/ase/ism/sap/DAY03/Encrypted.enc", "ism12345password".getBytes(), "AES");
        System.out.println("The end.");

        decrypt("src/main/java/ro/ase/ism/sap/DAY03/Encrypted.enc", "src/main/java/ro/ase/ism/sap/DAY03/msgDecrypECB.txt", "ism12345password".getBytes(), "AES");
        System.out.println("The end.");
    }
