...
int main(int argc, char** argv)
{
	...
	errno_t err1 = fopen_s(&fdst, "DAY3/encFile.bin", "wb+");
	...
	RSA* pubKey;
	FILE* fPubKey;
	err = fopen_s(&fPubKey, "DAY3/RSAPublicKey.pem", "rb");
	...
	FILE* encFile;
	err = fopen_s(&encFile, "DAY3/encFile.bin", "rb");
	...
	err = fopen_s(&fPrivKey, "DAY3/RSAPrivateKey.pem", "rb");
	...
	FILE* decryptedFile;
	err = fopen_s(&decryptedFile, "DAY3/decrypted.txt", "w+");
